...
정적 Apollo operation은 바로 렌더링하고, Redux state·route·theme·권한처럼 프로젝트 의미가 필요한
배경 계약은 임의로 꾸미지 않고 명확한 runtime setup 안내를 표시합니다. 복잡한 페이지는 작은 preview
harness로 실제 앱 bootstrap과 네트워크를 제외한 화면 계약만 조립할 수 있습니다.
...
- React Redux·Router 등 library-branded context 오류를 번들 실패와 구분하고 범용 harness/setup 안내
...
| Theme/Redux 또는 필수 props 오류  | 범용 진단에 따라 preview harness나 setup에서 정적 계약을 공급       |
