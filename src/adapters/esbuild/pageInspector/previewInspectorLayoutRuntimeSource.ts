...
const previewInspectorDevtoolsCss = [
  ...
  '.rpi-tree-row{align-items:center;background:transparent;border:0;color:inherit;cursor:default;display:flex;flex-wrap:wrap;gap:5px;',
  'max-width:100%;min-height:27px;min-width:0;padding:2px 6px;text-align:left;width:100%}',
  ...
  '.rpi-node-name{flex:1 1 100px;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}',
