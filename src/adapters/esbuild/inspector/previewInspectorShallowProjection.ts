...
export function createPreviewInspectorShallowProjectionSource(
  ...
  if (componentExportNames.length > 0) {
    lines.push(
      ...
      '    const fallbackStyle = children == null && navigationLike',
      '      ? {',
      ...
      '        }',
      "      : children == null && hostProps.className == null ? { display: 'inline-block', minHeight: '1em', minWidth: '1em' } : {};",
      ...
      "    if (navigationLike && children == null && hostProps['aria-label'] == null) {",
      "      hostProps['aria-label'] = semanticLabel;",
      '    }',
      '    const content = navigationLike && children == null',
      ...
      '        )',
      '      : children;',
      "    return React.createElement('span', hostProps, content);",
      '  };',
