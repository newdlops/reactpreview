...
const previewInspectorDevtoolsCss = [
  ...
  'display:grid;gap:8px;grid-column:1/-1;grid-template-columns:28px minmax(0,1fr) auto auto;padding:8px 9px}',
  ...
  '.rpi-friendly-status>.rpi-button{white-space:nowrap}.rpi-friendly-status>.rpi-context-badge{grid-row:auto}',
  ...
  '.rpi-tree-row{align-items:center;background:transparent;border:0;color:inherit;cursor:default;display:flex;gap:5px;',
  'min-height:27px;padding:2px 6px;text-align:left;width:100%}',
  ...
  'display:grid;gap:9px;grid-template-columns:28px minmax(0,1fr);padding:9px}',
  ...
  'font-weight:800;height:25px;justify-content:center;width:25px}.rpi-blocker-help-copy{display:grid;gap:2px}',
  '.rpi-blocker-help-copy>span{color:var(--rpi-muted);font-size:10px}',
  ...
  'border:1px solid var(--rpi-border);border-radius:4px;display:grid;gap:6px;grid-template-columns:minmax(0,1fr) auto;padding:9px}',
  ...
  '.rpi-flow-card-body{display:grid;gap:3px;min-width:0}.rpi-flow-card-heading{align-items:center;display:flex;gap:5px;min-width:0}',
