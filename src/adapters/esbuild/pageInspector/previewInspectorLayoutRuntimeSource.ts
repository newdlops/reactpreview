...
const previewInspectorDevtoolsCss = [
  ...
  '.rpi-button:focus-visible,.rpi-select:focus-visible,.rpi-search:focus-visible,.rpi-tree-row:focus-visible,.rpi-tab:focus-visible,.rpi-route-summary:focus-visible,.rpi-route-crumb:focus-visible,.rpi-route-folder:focus-visible,.rpi-route-item:focus-visible,',
