 ...
 */
export function createPreviewRuntimeCallableFallbackExpression(resultExpression?: string): string {
  if (resultExpression === undefined) return 'Object.freeze(() => undefined)';
