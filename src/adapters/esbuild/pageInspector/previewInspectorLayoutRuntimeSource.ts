...
const previewInspectorDevtoolsCss = [
  ...
  'display:flex;flex-wrap:wrap;gap:6px;max-width:100%;min-height:36px;overflow:auto;overscroll-behavior:contain;padding:5px 7px;scrollbar-gutter:stable}',
  ...
  'overflow:auto;overscroll-behavior:contain;padding:6px 8px;scrollbar-gutter:stable}',
  ...
  'max-width:100%;min-width:0;overflow:auto;overscroll-behavior:contain;padding:7px;scrollbar-gutter:stable}',
  ...
  '.rpi-route-crumb{padding:2px 6px}.rpi-route-folder{align-items:center;display:grid;gap:5px;grid-template-columns:auto minmax(0,1fr) auto;padding:5px 7px}',
  ...
  '.rpi-route-item.is-pending{opacity:.72}.rpi-route-kind{color:var(--vscode-symbolIcon-interfaceForeground,#75beff);font-weight:800}',
  '.rpi-route-label{font-family:var(--vscode-editor-font-family,monospace);min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}',
  ...
  '.rpi-components-body{display:grid;grid-template-rows:minmax(72px,var(--rpi-primary-section-height,3fr)) 9px 28px minmax(72px,2fr);',
