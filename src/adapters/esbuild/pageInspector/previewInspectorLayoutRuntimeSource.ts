...
const previewInspectorDevtoolsCss = [
  ...
  '.rpi-flow-overview{background:var(--vscode-editor-background,#1e1e1e);border:1px solid var(--rpi-border);border-radius:6px;',
  'display:grid;gap:0;max-width:100%;min-width:0;overflow:hidden}',
  '.rpi-flow-overview-section{display:grid;gap:3px;min-width:0;padding:8px 10px}',
  '.rpi-flow-overview-section+.rpi-flow-overview-section{border-top:1px solid var(--rpi-border)}',
  '.rpi-flow-overview-section[data-rpi-current-blocker="true"]{background:color-mix(in srgb,',
  'var(--vscode-errorForeground,#f48771) 7%,transparent)}',
  '.rpi-flow-overview-label{color:var(--rpi-muted);font-size:9px;font-weight:750;letter-spacing:.05em;text-transform:uppercase}',
  '.rpi-flow-overview-path,.rpi-flow-overview-blocker,.rpi-flow-overview-action{min-width:0;overflow-wrap:anywhere}',
  '.rpi-flow-overview-path{font-size:11px}.rpi-flow-overview-blocker{font-size:12px}.rpi-flow-overview-action{font-size:11px}',
  '.rpi-flow-overview-primary-editor{border-top:1px solid var(--rpi-border);display:grid;gap:6px;max-width:100%;min-width:0;padding:8px 10px}',
  '.rpi-flow-overview-primary-editor>.rpi-flow-node-editor{max-width:100%;min-width:0}',
  '.rpi-flow-overview-actions{border-top:1px solid var(--rpi-border);padding:8px 10px}',
  '.rpi-flowchart-advanced[hidden]{display:none}',
  ...
  '.rpi-flow-overview-actions>.rpi-button{flex:1 1 min(180px,100%)}',
  ...
  '.rpi-blocker-help{grid-template-columns:24px minmax(0,1fr);padding:7px}.rpi-blocker-flow{gap:7px;padding:6px}',
  '.rpi-flow-overview-section,.rpi-flow-overview-primary-editor,.rpi-flow-overview-actions{padding:7px}',
  '.rpi-flow-stage{padding-left:18px}.rpi-flow-stage::before{left:0}',
